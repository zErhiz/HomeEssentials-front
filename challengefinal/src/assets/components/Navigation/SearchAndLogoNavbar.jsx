  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5" />
          ...
          <div class="flex items-center">
            <input
              type="text"
              placeholder="Search..."
              class="rounded-l-full border-gray-300 bg-[#EDECEC] focus:outline-none focus:ring-2 focus:ring-black focus:border-black px-4 py-2 flex-1"
            />
        ...
        <div className=" lg:flex lg:justify-center lg:items-center lg:content-center lg:px-12 lg:gap-8">
          ...
          <div className=" lg:flex flex-row hidden lg:block">
            ...
            <h2 class="w-6 h-6 rounded-full bg-black text-white flex justify-center items-center">
              0
            </h2>
          </div>
        </div>
