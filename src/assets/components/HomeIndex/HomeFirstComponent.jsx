  ...
  return (
    <>
      <div className=' py-8 gap-2 selection:bg-[#7847E0] selection:text-[#ffe927] xl:py-0 xl:gap-0 h-[81.2vh] w-[100%] flex flex-col items-center xl:items-start xl:flex xl:flex-row xl:justify-end relative'>
        <div className=' content-center items-start w-[80%] lg:w-[50%] xl:w-[30%] xl:h-fit 2xl:w-[30%] xl:relative xl:z-10 xl:top-[30%] xl:left-[10%] gap-4 xl:flex-none lg:flex flex-col absolute  lg:left-[30%] left-[10%] top-10'>
