 ...
 const role = user?.role
  ...
  <div className="hidden lg:block flex justify-center content-center items-center">
    ...
    >
      ...
      <p className="font-normal text-xl">Favorites</p>
    </div>
  </div>
) : null}
           {seeButtonsAdmin ? (
        ...
        >
          ...
          <div className="h-full w-full flex flex-col gap-4 ">
              ...
              <div
                ...
                {!seeButtonsUser ? (
                  <div className="absolute top-10 lg:w-[7rem] 2xl:h-[5rem] 2xl:2-[10rem] lg:h-[4.5rem] bg-[#ffffff] shadow-[0_1px_10px_rgba(0,0,0,0.09)] drop-shadow-[0_0_1px_rgba(0,0,0,0.05)] rounded-lg z-30">
                    <button onClick={() => { 
                      navigate('/userPanel')  
                    setMenuIsOpen(!menuIsOpen) } } className="w-full h-1/2 text-start pl-2 hover:shadow-inner hover:bg-[#c6c6c621] hover:dark:shadow-black/10 text-sm"> User Panel</button>
            ...
            <div className="flex  w-[100%] h-1/4 items-center content-center justify-center  ">
             ...
             setMenuIsOpen(!menuIsOpen)}}  className='mx-2 text-lg underline'> About</Anchor>
                    <Anchor to='/contact' onClick={() =>{ 
             setMenuIsOpen(!menuIsOpen)}}  className='mx-2 text-lg underline'> Contact</Anchor>
                    <Anchor to='/attendance' onClick={() =>{ 
             setMenuIsOpen(!menuIsOpen)}}  className='mx-2 text-lg underline'> Attendance</Anchor>
